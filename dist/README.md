...
|-----------|---------------|----------------------|---------------------|
| 8 MB | 3.4 MB | 1 MB | 8.3 MB |

#### CDN links
> https://cdn.plot.ly/plotly-2.22.0.js

> https://cdn.plot.ly/plotly-2.22.0.min.js
...
|------|-----------------|------------------------|
| 2.6 MB | 963.7 kB | 322.4 kB |

#### CDN links
> https://cdn.plot.ly/plotly-basic-2.22.0.js

> https://cdn.plot.ly/plotly-basic-2.22.0.min.js
...
> https://cdn.plot.ly/plotly-cartesian-2.22.0.min.js
...
> https://cdn.plot.ly/plotly-geo-2.22.0.min.js
...
| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 3.6 MB | 1.5 MB | 487.2 kB |

#### CDN links
> https://cdn.plot.ly/plotly-gl3d-2.22.0.js

> https://cdn.plot.ly/plotly-gl3d-2.22.0.min.js
...
| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 4.2 MB | 1.8 MB | 576.8 kB |

#### CDN links
> https://cdn.plot.ly/plotly-gl2d-2.22.0.js

> https://cdn.plot.ly/plotly-gl2d-2.22.0.min.js
...
| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 4.2 MB | 1.7 MB | 523 kB |

#### CDN links
> https://cdn.plot.ly/plotly-mapbox-2.22.0.js

> https://cdn.plot.ly/plotly-mapbox-2.22.0.min.js
...
| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 2.8 MB | 1 MB | 350.7 kB |

#### CDN links
> https://cdn.plot.ly/plotly-finance-2.22.0.js

> https://cdn.plot.ly/plotly-finance-2.22.0.min.js
...
| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 8.4 MB | 3.7 MB | 1.1 MB |

#### CDN links
> https://cdn.plot.ly/plotly-strict-2.22.0.js

> https://cdn.plot.ly/plotly-strict-2.22.0.min.js
